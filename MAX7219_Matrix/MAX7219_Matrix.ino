...
#define MOVIE_LENGTH 21
/* the short animation we will display */
const byte movie[MOVIE_LENGTH][8] PROGMEM = {/*{B10000001,
                                              B10000001,
                                              B10000001,
                                              B10000001,
                                              B11111111,
...
const byte script[MOVIE_LENGTH][2] = {{1, 2}, {1, 2}, {1, 2}, {1, 2}, {1, 2},
                                      {1, 2}, {1, 2}, {1, 2}, {1, 2}, {1, 2}, 
                                      {1, 2}, {1, 2}, {1, 2}, {1, 2}, {1, 2}, 
                                      {1, 2}, {1, 2}, {1, 2}, {1, 2}, {1, 2}, 
                                      {1, 2}};
...
void animateArduino() {
  for(byte i = 0; i < MOVIE_LENGTH; i++) {
    for(byte j = 0; j < 8; j++) framebuffer[j] = pgm_read_byte(&movie[i][j]);
    switch(script[i][0]) {
      case 1:
